...
#define LIBAV_CONFIGURATION "--disable-asm --disable-debug --disable-everything --enable-decoder=vp6 --disable-programs --disable-avresample --disable-avfilter --disable-vdpau --disable-network --disable-pthreads --disable-zlib"
