...
pub struct Picture {
    ...
    pub options: EnumSet<PictureOption>,
    ...
    pub slice_submode: Option<EnumSet<SliceSubmode>>,
    ...
    /// partner.
    pub reference_picture_selection_mode: Option<EnumSet<ReferencePictureSelectionMode>>,
...
/// header.
pub const OPPTYPE_OPTIONS: EnumSet<PictureOption> = enum_set!(
...
/// header.
pub const MPPTYPE_OPTIONS: EnumSet<PictureOption> = enum_set!(
...
/// decoding partner.
#[derive(EnumSetType, Debug)]
pub enum ReferencePictureSelectionMode {
    Reserved,
    RequestNegativeAcknowledgement,
