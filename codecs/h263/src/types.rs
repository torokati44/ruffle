...
pub struct Picture {
    ...
    /// `Picture`.
    options_enabled: EnumSet<PictureOption>,

    /// Options which have been explicitly disabled by this particular
    /// `Picture`.
    options_disabled: EnumSet<PictureOption>,
    ...
    slice_submode: Option<EnumSet<SliceSubmode>>,
    ...
    /// partner.
    reference_picture_selection_mode: Option<EnumSet<ReferencePictureSelectionMode>>,
