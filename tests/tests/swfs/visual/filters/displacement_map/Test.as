package  {
	...
	public class Test extends MovieClip {
		...
		public function Test() {
			...
			//trace(bmd.generateFilterRect(bmd.rect, new DisplacementMapFilter(bmd, new Point(50, 20), BitmapDataChannel.RED, BitmapDataChannel.BLUE, 5, 10, DisplacementMapFilterMode.COLOR)));
